...
Route::delete('/lecturerdelete/{id}', ['uses'=> 'Admin\LecturerCrudController@lecturerdelete']);

Route::get('/lecturerupdate/{id}', ['uses'=> 'Admin\LecturerCrudController@lecturerupdate']);
Route::put('/lecturerupdatesave/{id}', ['uses' => 'Admin\LecturerCrudController@lecturerupdatesave']);
