...
//        Lecturer::create($request->all());
    ...
    public function lecturerupdate($id)
    {
        if (Session::get('lecturerid') == "") return Redirect::to('.');

        $lecturer = Lecturer::find($id);
        return View('lecturerupdate', ['lecturer' => $lecturer]);
    }

    public function lecturerupdatesave($id, Request $request)
    {
        $data = [
        ...
        $update = Lecturer::where('id', $id)->update($data);
